...
function Menu() {
  ...
  return (
    <div className='bg-gray-50 w-full md:p-10 p-5 pt-10 md:px-20 relative'>
        <button className='absolute top-5 right-5 border-gray-300 bg-white md:right-10 hover:bg-green-500 hover:text-white font-semibold flex items-center gap-1 border p-1 rounded-lg'>
